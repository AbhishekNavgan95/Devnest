...
const Signup = () => {
  return (
    <Container>
      <div className='w-full py-24 md:py-44 flex items-center gap-x-14'>
        <div className='md:w-1/2 w-full'>
          {/* <img src={logo} alt="devnest" className='w-[180px] mb-8' /> */}
          <h2 className='text-lg md:text-2xl font-medium'>Create an Account to  </h2>
          <h2 className='text-2xl md:text-4xl mt-4 font-semibold'><HilightText className={'py-1'}>Get Started Today</HilightText></h2>
