...
const CourseSkeletonLoader = () => {
    return (
        <div className='my-8 md:my-24'>
            <Container>
                <div>
                    <div className='bg-dark-200 animate-pulse rounded-md h-12 w-2/3'></div>
                    <div className='hidden md:grid grid-cols-3 mt-14 gap-x-4'>
                        {
                    ...
                    <div className='grid md:hidden grid-cols-1 mt-14 gap-x-4'>
                        {
